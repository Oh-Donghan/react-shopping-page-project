...
export default function Nav() {
  ...
  const itemCount: number = Object.values(cartItem.items ?? {}).reduce((prev, item) => prev + item.count, 0);
  ...
  return (
    <div className="fixed z-10 w-full navbar shadow-lg bg-white dark:bg-neutral text-neutral-content">
      <div className="flex w-full xl:container xl:m-auto">
        ...
        <div className="shrink-0 flex md:flex-none flex-1 mx-1 sm:mx-2">
        ...
        <div className="flex items-center px-2">
          <label className="swap swap-rotate mr-2 sm:mr-4">
            <input type="checkbox" className="js-theme" onClick={toggleTheme} readOnly checked={theme === "light"} />
